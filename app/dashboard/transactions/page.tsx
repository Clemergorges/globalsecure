  ...
  return (
    <div className="space-y-6 max-w-[1600px] mx-auto pb-20">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold">Extrato Detalhado</h1>
          <p className="text-gray-500">Visualize e filtre todo o seu histórico financeiro.</p>
        </div>
            ...
            {loading ? (
              <TableRow>
                <TableCell colSpan={5} className="h-48 text-center">
                  <Loader2 className="animate-spin mx-auto w-8 h-8 text-[var(--color-primary)]" />
                </TableCell>
              </TableRow>
